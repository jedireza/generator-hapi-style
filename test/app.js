...
const testDest = Path.join(__dirname, 'generators', 'tmp-app');
const appSrc = Path.join(__dirname, '..', 'app');
const appName = 'super-awesome-app';
const appDest = Path.join(__dirname, 'generators', 'tmp-app', appName);
const internals = { gitConfigErr: false };
const GeneratorApp = Proxyquire('../app', {
